# Contributing to Philosopher's Stone
...
Feature requests can be discussed on [the elixir-talk mailing list](https://groups.google.com/group/elixir-lang-talk).
...
[contribute to Philosopher's Stone](#contributing).
...
1. **Use the GitHub issue search** &mdash; [check if the issue has already been
   reported](https://github.com/philosophers-stone/REPO/search?type=Issues).
...
Feature requests are welcome and should be discussed on [the elixir-talk mailing list](https://groups.google.com/group/elixir-lang-talk). But take a moment to find
...
1. [Fork](https://help.github.com/fork-a-repo/) the project, clone your fork,
  ...
  git remote add upstream https://github.com/philosophers-stone/<repo>
  ```
